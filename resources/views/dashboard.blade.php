...
<div class="col-sm-6">
    <h4 class="mb-0" style="font-family: 'Cairo', sans-serif">
        لـوحـة تحـكـم : <label style="color: #5686E0">الـ{{ auth()->user()->job }}</label>
...
<div class="col-xl-3 col-lg-6 col-md-6 mb-30">
    <div class="card card-statistics h-100">
        <div class="card-body">
            ...
            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a
                    href="{{ route('Fees_Invoices.index') }}" target="_blank"><span
                        class="text-danger">عرض البيانات</span></a>
            </p>
        </div>
    </div>
...
<div class="col-xl-3 col-lg-6 col-md-6 mb-30">
    <div class="card card-statistics h-100">
        <div class="card-body">
            ...
            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a
                    href="{{ route('Classrooms.index') }}" target="_blank"><span
                        class="text-danger">عرض البيانات</span></a>
            </p>
        </div>
    </div>
            ...
            <div class="tab nav-border" style="position: relative;">
                <div class="d-block d-md-flex justify-content-between">
                    <div class="d-block w-100">
                        <h5 style="font-family: 'Cairo', sans-serif" class="card-title">اخر
                            العمليات علي النظام</h5>
                    </div>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active show" id="students-tab"
                                    ...
                                    aria-controls="students" aria-selected="true"> الطلاب</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="parents-tab" data-toggle="tab"
                                    ...
                                    aria-selected="false"> الفواتير الـدراسيـة
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="fee_invoices-tab" data-toggle="tab"
                                    href="#fee_invoices" role="tab"
                                    aria-controls="fee_invoices" aria-selected="false">سندات القبض
                                </a>
                            </li>
                        </ul>
                    </div>
                            ...
                            <table style="text-align: center"
                                ...
                                <thead>
                                    <tr class="table-info text-danger">
                                        <th
                                            style="text-align: center; background-color: #D0DEF6; font-weight:bolder;">
                                            #</th>
                                        <th
                                            style="text-align: center; background-color: #D0DEF6; font-weight:bolder;">
                                            أسم الطالب</th>
