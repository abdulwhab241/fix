    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="{{ route('dashboard.Students') }}" class="default-color">الرئيسية</a>
                </li>
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                    ...
                    <div class="box-header">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center">
                                ...
                                <p style="font-weight: bolder;">المرحلة الدراسية:
                                    {{ $Student_Name->student->grade->name }} </p>
                                <p style="font-weight: bolder;">الصـف:
                                    {{ $Student_Name->student->classroom->name_class }} </p>
                                <p style="font-weight: bolder;">الشعبـة:
                                    {{ $Student_Name->student->section->name_section }} </p>
                                <p style="font-weight: bolder;">تـاريـخ المـيلاد:
                                    {{ $Student_Name->student->birth_date }} </p>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center">
                                <h4>شهادة تقويم أعمال السنة وإمتـحان النـقل في <label
                                        style="color: #5686E0; margin:5px;">{{ $Student_Name->student->grade->name }}</label>
                                    للـعام الـدراسـي <label
                                        style="color: #5686E0; margin:5px;">{{ date('Y') }}</label> </h4>
                            </div>
                        ...
                        <table class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                            ...
                            <thead>
                                <tr class="alert-success">
                                    ...
                                    <th style="text-align: center; background-color: #D0DEF6;" colspan="6">درجات
                                        الفصل الاول 50% </th>
                                    <th style="text-align: center; background-color: #D0DEF6;" colspan="6">درجات
                                        الفصل الثـانـي 50% </th>
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center; background-color: #D0DEF6;" colspan="7">المجمـوع
                                        النـهائـي <label style="color: black; margin:5px;">{{ $All }}</label>
                                    </th>
                                    ...
                                    @else
                                        ...
                                        @endif
                                    @endif
                                    <th style="text-align: center; background-color: #D0DEF6;" colspan="6">النتيجـة
                                        النـهائيـة <label style="color: black; margin:5px;">{{ $type }}</label>
                                    </th>
                                    ...
                                    @php
                                        ...
                                        $total += $sub_total;
                                    @endphp
                                    <th style="text-align: center; background-color: #D0DEF6;" colspan="1">
                                        {{ $sub_total }} %</th>
                ...
                @else
                    <h1
                        style="margin: 10px; padding:10px; font-weight: bold; text-align: center; background-color:#85A8CF; ">
