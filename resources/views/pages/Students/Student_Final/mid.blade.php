                        ...
                        <table class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                            ...
                            <thead>
                                <tr class="alert-success">
                                    ...
                                    <th style="text-align: center; background-color: #D0DEF6;">إمتحـان نهـايـة الفـصل
                                        الاول</th>
                            ...
                            <tfoot>
                                @php $type = ''; @endphp
                                <tr>
                                    <th style="text-align: center; background-color: #D0DEF6;" colspan="2">المجمـوع
                                        النـهائـي <label style="color: black; margin:5px;">
                                            {{ $Mid_Results->sum('total') }}</label> </th>
                                    ...
                                    @endif
                                    <th style="text-align: center; background-color: #D0DEF6;" colspan="2">النتيجـة
                                        النـهائيـة <label style="color: black; margin:5px;"> {{ $type }}
                                        </label> </th>
