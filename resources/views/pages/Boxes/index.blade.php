        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                <a href="{{ route('export_Boxes') }}" class="btn btn-info btn-sm" role="button"
                    style="margin: 5px; padding: 5px;" aria-pressed="true"> <i class="fas fa-file-download"></i> تصـديـر
                    إكسـيل</a>
                    ...
                    <table id="data" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                        ...
                        <thead>
                            <tr class="alert-dark">
                                ...
                                <th style="text-align: center; background-color: #86B9D4;">أسـم الطـالـب \ الطـالبـة
                                </th>
