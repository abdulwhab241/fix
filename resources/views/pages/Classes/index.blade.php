        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                <div class="box-body">
                    ...
                    <a class="btn btn-primary btn-flat" title="تصـديـر إكسـيل"
                        href="{{ route('export_student_classes') }}">
                        ...
                        <tbody>
                            @foreach ($StudentClasses as $StudentClass)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('Classes.edit', $StudentClass->id) }}"
                                                style="margin: 3px;" class="btn btn-info btn-sm" role="button"
                                                aria-pressed="true" title="تعديل">تعديل</a>
                                            <button type="button" class="btn btn-danger btn-sm" style="margin: 3px;"
                                                data-toggle="modal" data-target="#delete{{ $StudentClass->id }}"
                                                title="حذف">حذف</button>
                                        </div>
                                    </td>
                                </tr>

                                <div class="modal fade" id="delete{{ $StudentClass->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title"
                                                        id="exampleModalLabel">حـذف جدول الحصص ليوم</h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="text" style="font-weight: bolder; font-size:20px;"
                                                        ...
                                                        value="{{ $StudentClass->day }}" disabled>
                                                </div>
