            ...
            <div class="card-body">
                <div class="box-body">
                    <a href="{{ route('Results.create') }}" class="btn btn-success btn-sm"
                        style="margin: 5px; padding: 5px;" role="button" aria-pressed="true">اضافة نتيـجـة</a>
                    <a class="btn btn-primary btn-sm" style="margin: 5px; padding: 5px;" title="تصـديـر إكسـيل"
                        href="{{ route('export_results') }}">
                        ...
                        <tbody>
                            ...
                            @foreach ($Results as $Result)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('Results.edit', $Result->id) }}" style="margin: 3px;"
                                                title="تعديل" class="btn btn-info btn-sm" role="button"
                                                aria-pressed="true">تعديل</a>
                                            <button type="button" class="btn btn-danger btn-sm" style="margin: 3px;"
                                                data-toggle="modal" data-target="#delete_Result{{ $Result->id }}"
                                ...
                                <!-- Delete modal -->
                                <div class="modal fade" id="delete_Result{{ $Result->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title"
                                                        ...
                                                        حـذف نتيـجة الطـالـب <label
                                                            style="color: #5686E0; font-weight:bolder; font-size: 20px;">{{ $Result->student->name }}</label>
                                                    </h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="text" style="font-weight: bolder; font-size:20px;"
                                                        name="Name_Section" class="form-control"
                                                        value="{{ $Result->student->name }}" disabled>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-outline"
                                                        data-dismiss="modal">إغلاق</button>
                                                    <button type="submit" class="btn btn-danger">تـأكـيد</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
