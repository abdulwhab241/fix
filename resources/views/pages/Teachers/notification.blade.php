...
<div class="table-responsive">
    <table class="table  table-hover table-sm table-bordered p-0"
        ...
        <tr class="alert-success">
            <th style="text-align: center; background-color: #D0DEF6;" >أسم المعلم</th>
            <th style="text-align: center; background-color: #D0DEF6;" >النوع</th>
            <th style="text-align: center; background-color: #D0DEF6;" > التخصص</th>
            <th style="text-align: center; background-color: #D0DEF6;" >تاريخ التعيين</th>
        ...
        <tbody>
            <tr>
                ...
                <td>{{$Teachers->create_by}}</td>
                <td>{{$Teachers->created_at->diffForHumans()}}</td>
