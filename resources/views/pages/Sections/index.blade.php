...
<div class="card-body">
<a class="btn btn-success btn-sm" href="#" data-toggle="modal" style="padding:5px; margin: 5px;"
    ...
    <table class="table table-hover table-sm table-bordered p-0"
        ...
        <thead>
            <tr class="text-dark">
                ...
                <th style="text-align: center;" class="alert-info"> المرحلـة
                </th>
                <th style="text-align: center;" class="alert-info"> الصـف</th>
                <th style="text-align: center;" class="alert-info"> القسـم</th>
                <th style="text-align: center;" class="alert-success"> انشـئ
                    بواسطـة</th>
                <th style="text-align: center;" class="alert-warning">العمليات
                </th>
            </tr>
        </thead>
        <tbody>
            ...
            @foreach ($Grade->Sections as $list_Sections)
                            ...
                            <div class="modal-body">
                                ...
                                <form class="form-horizontal"
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit"
                                            class="btn btn-success btn-block">تعديل
                                            البيانات</button>
                                    </div>
                ...
                <div class="modal fade"
                    id="delete_section{{ $list_Sections->id }}"
                    tabindex="-1" role="dialog"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-body">
                                <form
                                    ...
                                    <input id="Name" type="text"
                                        ...
                                        disabled
                                        style="text-align: center; font-weidth:bolder; font-size:20px;">
