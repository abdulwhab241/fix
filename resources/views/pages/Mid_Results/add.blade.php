...
<div class="row">
<div class="col-sm-6">
<h4 class="mb-0">  اضافة نتيـجـة الطـالـب للـترم الاول</h4>
</div>
<div class="col-sm-6">
<ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
<li class="breadcrumb-item"><a href="{{ route('dashboard') }}" class="default-color">الرئيسية</a></li>
<li class="breadcrumb-item active"> اضافة نتيـجـة الطـالـب للـترم الاول</li>
</ol>
</div>
</div>
</div>
<!-- breadcrumb -->
@section('PageTitle')
اضافة نتيـجـة الطـالـب للـترم الاول
@stop
<!-- breadcrumb -->
@endsection
@section('content')
