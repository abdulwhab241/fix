...
<title>برنامج عبدالوهاب لادارة المدارس</title>
    ...
    <!-- css -->
    <link href="{{ URL::asset('assets/css/rtl.css') }}" rel="stylesheet"></head>
<body >
...
<div class="login-fancy pb-40 clearfix">
    @if($type == 'student')
        <h3 style="font-family: 'Cairo', sans-serif; font-weight: bolder;" class="mb-40">تسجيل دخول طالب</h3>
    @elseif($type == 'teacher')
        <h3 style="font-family: 'Cairo', sans-serif; font-weight: bolder;" class="mb-40">تسجيل دخول معلم</h3>
    @else
